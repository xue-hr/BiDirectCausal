                       ...
                       random_start = 0, random.seed = 0)
{
  ...
  MRcML_YtoX_S = mr_cML_DP(b_exp = b_Y[ind_Y_new],
                           ...
                           random_start_pert = random_start,
                           num_pert = num_pert)
  return(list(XtoY.est.NoS = MRcML_XtoY_NoS$BIC_theta,
              XtoY.se.NoS = MRcML_XtoY_NoS$BIC_se,
              YtoX.est.NoS = MRcML_YtoX_NoS$BIC_theta,
              YtoX.se.NoS = MRcML_YtoX_NoS$BIC_se,
              XtoY.est.S = MRcML_XtoY_S$BIC_theta,
              XtoY.se.S = MRcML_XtoY_S$BIC_se,
              YtoX.est.S = MRcML_YtoX_S$BIC_theta,
              YtoX.se.S = MRcML_YtoX_S$BIC_se,
              XtoY.est.NoS.DP = MRcML_XtoY_NoS$BIC_DP_theta,
              XtoY.se.NoS.DP = MRcML_XtoY_NoS$BIC_DP_se,
              YtoX.est.NoS.DP = MRcML_YtoX_NoS$BIC_DP_theta,
              YtoX.se.NoS.DP = MRcML_YtoX_NoS$BIC_DP_se,
              XtoY.est.S.DP = MRcML_XtoY_S$BIC_DP_theta,
              XtoY.se.S.DP = MRcML_XtoY_S$BIC_DP_se,
              YtoX.est.S.DP = MRcML_YtoX_S$BIC_DP_theta,
              YtoX.se.S.DP = MRcML_YtoX_S$BIC_DP_se))
}
